...
var userSchema = new Schema({
    ...
    groups      : [{ type: Number, required: false, unique: false, ref: 'Group' }],
    permissions : [{ type: Number, required: false, unique: false, ref: 'Permission' }]
});
...
var groupSchema = new Schema({
    ...
    members     : [{ type: Number , required: false, unique: false, ref: 'User' }],
    permissions : [{ type: Number , required: false, unique: false, ref: 'Permission' }]
});
...
var permissionSchema = new Schema({
    ...
    description : { type: String , required: false, unique: false },
    parent      : { type: Number , required: false, unique: false, ref: 'Permissions Category' }
});
