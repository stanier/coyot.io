...
router.get('/overview',          render('panel/server/view'));
...
router.get('/package/view',      render('panel/server/packages/view'));
router.get('/services',          render('panel/server/services/list'));
router.get('/service/view',      render('panel/server/services/view'));
